...
5. **Register your locale** in `lib/main.dart`:
   ...
   ```
6. **Submit a Pull Request** linking to your discussion issue
7. **Test the APK** generated by GitHub Actions from the workflow artifacts
8. **Share your draft** in the issue for feedback from other native speakers
